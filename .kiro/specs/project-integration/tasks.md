...
- [ ] 2. 實作平行路由架構
  - 建立 App Router 的平行路由結構，包含 @portfolio、@partners、@documents、@analytics 槽
  - 實作統一的儀表板佈局和導航系統
  - 建立模組載入、錯誤處理和預設狀態元件
...
- [ ] 8. 實作 Portfolio 模組
  - 遷移和重構 Portfolio 專案的所有功能元件
  - 整合統一的 UI 設計系統和資料層
  - 實作模組內的路由、狀態管理和 AI 功能
  - _需求: 3.1, 3.2, 3.3, 3.4, 3.5_

- [ ] 8.1 建立 Portfolio 基礎元件
  - 重構專案管理相關的 UI 元件
  - 建立專案卡片、列表、表單等核心元件
  - 整合統一的設計系統和樣式
  - _需求: 3.1, 7.1_
...
- [ ] 9. 實作 PartnerVerse 模組
  - 遷移和重構 PartnerVerse 專案的合作夥伴管理功能
  - 整合統一的 UI 設計系統和資料層
  - 實作夥伴關係視覺化和協作功能
  - _需求: 4.1, 4.2, 4.3, 4.4, 4.5_

- [ ] 9.1 建立 Partners 基礎元件
  - 重構夥伴管理相關的 UI 元件
  - 建立夥伴卡片、目錄、表單等核心元件
  - 整合統一的設計系統和樣式
  - _需求: 4.1, 7.1_
...
- [ ] 9.4 實作協作管理功能
  - 建立協作專案建立和管理介面
  - 實作協作狀態追蹤和進度管理
  - 整合與 Portfolio 模組的專案關聯
  - _需求: 4.3, 4.4, 6.1_

- [ ] 10. 實作 DocuParse 模組
  - 遷移和重構 DocuParse 專案的文件處理功能
  - 整合統一的 UI 設計系統和資料層
  - 實作 AI 文件解析和跨模組文件關聯
  - _需求: 5.1, 5.2, 5.3, 5.4, 5.5_

- [ ] 10.1 建立 Documents 基礎元件
  - 重構文件管理相關的 UI 元件
  - 建立文件上傳器、檢視器、庫等核心元件
  - 整合統一的設計系統和樣式
  - _需求: 5.1, 7.1_
